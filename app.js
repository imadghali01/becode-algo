...
*/
function isThisGambleGood(winChance,prize,playCost){
    if(winChance*prize>playCost){
        return true;
    }
    else{
        return false;
...
console.log(isThisGambleGood(0.2, 50, 9));
console.log(isThisGambleGood(0.9, 1, 2));
console.log(isThisGambleGood(0.9, 3, 2));
